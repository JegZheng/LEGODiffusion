# Original dataset definition code from NVIDIA StyleGAN2-ADA-PyTorch
# Added support for latent .npy files
...
class Dataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        use_latent  = False,    # trained with latent .npy?
    ):
        self._name = name
    ...
    def __getitem__(self, idx):
        ...
        if self._xflip[idx]:
            assert image.ndim == 3  or image.ndim == 4 # CHW
            image = image[:, :, ::-1]
